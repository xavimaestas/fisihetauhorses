...
<div className="meet-horses-page-container" >
        ...
        <div className="meet-horses-text">
                <h4>Stan</h4>
                <p>Handsome and kind... Stanley is a papered American Quarter Horse standing at 16 hands. He doubles as a therapy horse in an instance. 😉 He is without a doubt Sam's kindred spirit. He was sired in Farmington, Utah and is 13 years of age. </p>
            </div>
        ...
        <div className="meet-horses-text  ">
            <h4>Sunshine</h4>
            <p>The boss, smart and swift. Sunshine has striking blue and brown eyes, fitting her personality perfectly. Her fierce disposition 😉 would make her serious competition as the boss mare in any herd. Sunshine is a papered American Paint Horse and stands at 16.1 hands tall. She was sired in Lehi, Utah and is 12 years of age. Sunshine is certainly Sam’s ride or die. </p>
        </div>
  ...
  {/* Horse 3 */}
        ...
        <div className="meet-horses-text ">
                <h4> Nocona</h4>
                <p>Nebraska boy, sold to the Lone Star state, finally finding home in the Rocky Mountains. Nocona is a papered American Quarter Horse standing at an astounding 16.2 hands and he is 12 years of age. His strides are smooth, like a one-ton pickup loaded down. Nocona's awareness and tolerance for children is remarkable (available for babysitting). 😉</p>
            </div>

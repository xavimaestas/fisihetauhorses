        ...
        <section className="all_info" id="all_info">
            ...
            <div className="bio_container" id="bio_container">
                ...
                <div className="horse_container">
                    ...
                    <video className="sam_riding_v1 content" preload="auto" loop muted controls src={samRiding1} poster={samRiding1Ph}></video>
                    ...
                    <video className="sam_riding_v1 content video_margin" src={samRiding5} poster={samRiding5Ph} preload="auto" loop muted="muted" controls="controls"></video>
